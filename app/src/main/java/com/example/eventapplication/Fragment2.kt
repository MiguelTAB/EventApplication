...
class Fragment2 : Fragment(R.layout.fragment1) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        titleA = arrayOf(
            ...
            "Cerimónia Arriar Bandeira",
            "Demonstração cinotécnica",
            "Concerto Banda do Exército",
            "Fogo de Artificio",
            "Encerramento",
        )
        ...
        detailA = arrayOf(
            ...
            "Theatro Circo - Lorem ipsum dolor sit amet, consectetur adipiscing elit. In vestibulum, lectus sit amet tristique placerat, sem leo facilisis velit, ultrices pellentesque erat justo quis nulla. Etiam libero odio, ultrices a pulvinar ut, condimentum sed turpis.",
            "Monte Picoto - Lorem ipsum dolor sit amet, consectetur adipiscing elit. In vestibulum, lectus sit amet tristique placerat, sem leo facilisis velit, ultrices pellentesque erat justo quis nulla. Etiam libero odio, ultrices a pulvinar ut, condimentum sed turpis.",
            "Avenida da Liberdade - Lorem ipsum dolor sit amet, consectetur adipiscing elit. In vestibulum, lectus sit amet tristique placerat, sem leo facilisis velit, ultrices pellentesque erat justo quis nulla. Etiam libero odio, ultrices a pulvinar ut, condimentum sed turpis.",
        )
    ...
    private fun initRecyclerView(view: View){
        ...
        adapter.setOnItemClickListener(object : RecyclerAdapter.onItemClickListener{
            override fun onItemClick(position: Int) {
                ...
                Log.i("Fragment2","bundle input day ${day}")
                bundle.putInt("month", month)
                Log.i("Fragment2","bundle input month ${month}")
                bundle.putString("timestart", timeStartA[position])
                Log.i("Fragment2","bundle input time start ${timeStartA[position]} position ${position}")
                bundle.putString("timeend", timeEndA[position])
                Log.i("Fragment2","bundle input time end ${timeEndA[position]} position ${position}")
                bundle.putString("title", titleA[position])
                Log.i("Fragment2","bundle input title ${titleA[position]} position ${position}")
                bundle.putString("detail", detailA[position])
                Log.i("Fragment2","bundle input detail ${detailA[position]} position ${position}")
